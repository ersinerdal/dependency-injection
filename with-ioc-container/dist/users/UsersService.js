...
let UsersService = class UsersService {
    ...
    getById(userId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { data: { id, name, username, email, phone }, } = yield this.usersClient.get(`users/${userId}`);

...
describe("UsersService", () => {
  ...
  beforeEach(() => {
    ...
    container
      .bind(constants_1.TYPES.USERS_CLIENT)
      .toConstantValue({ get: getSpy });
    container
      .bind(constants_1.TYPES.COMMENTS_SERVICE)
      .toConstantValue({ listByUserId: listByUserIdSpy });
    container
      .bind(constants_1.TYPES.USERS_SERVICE)
      .to(UsersService_1.UsersService);
  ...
  it("fetches a user", () =>
    __awaiter(void 0, void 0, void 0, function* () {
      ...
      expect(user).toEqual(
        Object.assign(Object.assign({}, mockUserResponse), {
